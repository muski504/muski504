...
I am a passionate Software Engineer dedicated to building responsive, user-centric web applications and exploring data-driven solutions. With a strong background in software development and digital strategy, I focus on writing clean, scalable code and creating engaging digital experiences.

---

### 🚀 What I Do

* 🎨 **Web Development:** Building modern, responsive web applications using **React, JavaScript, HTML5, CSS3, and Tailwind/Bootstrap**.
* 🤖 **Data Science & AI:** Exploring neural network architectures, machine learning concepts, and data analytics.
* 📈 **SEO & Digital Strategy:** Optimizing web applications for search performance, user visibility, and search engine algorithms.
...
* 🥇 **Academic Excellence** | Graduated **1st Position** in Software Engineering degree.
